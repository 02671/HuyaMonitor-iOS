...
- Instructions:
  ...
  - Audio refresh/overlap matches Windows `audio.py`: resign the URL every 120 seconds (`REFRESH_SEC`) and overlap the old/new players for 2.0 seconds (`OVERLAP_SEC`) before tearing down the old one.
